...
// Import images
import heroMask from '@site/static/img/landing/hero-mask.svg';
...
export default function Home() {
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <div className="tw-py-8 tw-gap-6 tw-max-w-7xl tw-m-auto tw-flex tw-flex-col tw-items-start tw-justify-center lg:tw-py-32">
        <span className="tw-bright tw-text-lg">Free to get started. No credit card needed.</span>
        <h1 className="tw-text-5xl tw-leading-none tw-tracking-wider tw-mb-2 lg:tw-text-[108px]">
      ...
      <div 
        className="tw-relative tw--mt-64 tw--ml-10 tw-flex tw-justify-start tw-h-[600px] tw-overflow-hidden tw--z-10 [tw-mask-size:130%] tw-w-[120%] lg:tw-w-auto lg:tw-h-[1400px] lg:tw-ml-0"
        style={{
      ...
      <div className="tw-pb-8 tw-gap-6 tw-max-w-7xl tw-m-auto tw-flex tw-flex-col tw-items-start tw-justify-center lg:tw-pb-32">
        <span className="tw-bright tw-text-2xl tw-font-medium">
          Why EchoDash?
        </span>
        <h2 className="tw-text-3xl tw-leading-tight lg:tw-text-5xl">
      ...
      {/* Feature Section 1 */}
      <div className="tw-py-16 tw-gap-16 tw-max-w-7xl tw-m-auto tw-flex tw-flex-col tw-items-center lg:tw-py-32 lg:tw-flex-row">
        ...
        <div className="tw-w-full tw-flex tw-flex-col tw-gap-20 tw-items-start">
          <h2 className="tw-text-3xl tw-leading-tight lg:tw-text-5xl">Cure notification blindness.</h2>
          <ul className="tw-list-none">
            <li className="tw-flex tw-gap-4 tw-items-center tw-text-xl">
              <BulletArrow className="tw-text-white" />Cut down on notifications.
            </li>
            <li className="tw-flex tw-gap-4 tw-items-center tw-mt-2 tw-text-xl">
              <BulletArrow className="tw-text-white" />Filter notifications by source or type.
            </li>
            <li className="tw-flex tw-gap-4 tw-items-center tw-mt-2 tw-text-xl">
              <BulletArrow className="tw-text-white" />See only the alerts that matter.
            </li>
          </ul>
        </div>
      </div>
      ...
      {/* Feature Section 2 */}
      <div className="tw-py-16 tw-gap-16 tw-max-w-7xl tw-m-auto tw-flex tw-items-center tw-flex-col-reverse lg:tw-py-32 lg:tw-flex-row">
        <div className="tw-w-full tw-flex tw-flex-col tw-gap-20 tw-items-start">
          <h2 className="tw-text-3xl tw-leading-tight lg:tw-text-5xl">Real time alerts.</h2>
          <ul className="tw-list-none">
            <li className="tw-flex tw-gap-4 tw-items-center tw-text-xl">
              <BulletArrow className="tw-text-white" />All your apps and services, in real time.
            </li>
            <li className="tw-flex tw-gap-4 tw-items-center tw-mt-2 tw-text-xl">
              <BulletArrow className="tw-text-white" />Assign alerts to those responsible.
            </li>
            <li className="tw-flex tw-gap-4 tw-items-center tw-mt-2 tw-text-xl">
              <BulletArrow className="tw-text-white" />Customize what you want to see.
            </li>
          </ul>
        </div>
        <div className="tw-bg-[#FAFF00] tw-w-full tw-max-h-96 tw-flex tw-flex-shrink-0 tw-rounded-[48px] tw-items-start tw-justify-start tw-overflow-hidden lg:tw-max-w-[600px] lg:tw-max-h-[600px]">
          <img 
            ...
            className="tw-max-w-none tw-w-[1440px] tw-ml-24 tw-mt-24 tw-rounded-xl"
            style={{ boxShadow: '-10px -10px 100px rgba(0,0,0,0.3)' }}
            alt="EchoDash Real-time Alerts"
          />
        </div>
      </div>

      {/* Feature Section 3 - Data Safety */}
      <div className="tw-py-16 tw-gap-16 tw-max-w-7xl tw-m-auto tw-flex tw-flex-col tw-items-center lg:tw-py-32 lg:tw-flex-row">
        <div className="tw-bg-[#FAFF00] tw-w-full tw-max-h-96 tw-flex tw-flex-shrink-0 tw-rounded-[48px] tw-items-start tw-justify-start tw-overflow-hidden lg:tw-max-w-[600px] lg:tw-max-h-[600px]">
          <img 
            src={screenshot3}
            className="tw-max-w-none tw-w-[1440px] tw-ml-24 tw-mt-24 tw-rounded-xl"
            style={{ boxShadow: '-10px -10px 100px rgba(0,0,0,0.3)' }}
            alt="EchoDash Data Safety"
          />
        </div>
        <div className="tw-w-full tw-flex tw-flex-col tw-gap-20 tw-items-start">
          <h2 className="tw-text-3xl tw-leading-tight lg:tw-text-5xl">Your data stays safe.</h2>
          <ul className="tw-list-none">
            <li className="tw-flex tw-gap-4 tw-items-center tw-text-xl">
              <BulletArrow className="tw-text-white" />We never sell your data.
            </li>
            <li className="tw-flex tw-gap-4 tw-items-center tw-mt-2 tw-text-xl">
              <BulletArrow className="tw-text-white" />You always control how long its retained.
            </li>
            <li className="tw-flex tw-gap-4 tw-items-center tw-mt-2 tw-text-xl">
              <BulletArrow className="tw-text-white" />Delete it all, forever, whenever.
            </li>
          </ul>
        </div>
      </div>

      {/* Feature Section 4 - Slack */}
      <div className="tw-py-16 tw-gap-16 tw-max-w-7xl tw-m-auto tw-flex tw-flex-col-reverse tw-items-center lg:tw-py-32 lg:tw-flex-row">
        <div className="tw-w-full tw-flex tw-flex-col tw-gap-20 tw-items-start">
          <h2 className="tw-text-3xl tw-leading-tight lg:tw-text-5xl">Slack, off.</h2>
          <ul className="tw-list-none">
            <li className="tw-flex tw-gap-4 tw-items-center tw-text-xl">
              <BulletArrow className="tw-text-white" />No more crucial events buried in a Slack channel.
            </li>
            <li className="tw-flex tw-gap-4 tw-items-center tw-mt-2 tw-text-xl">
              <BulletArrow className="tw-text-white" />Custom alerts and feeds for each team.
            </li>
            <li className="tw-flex tw-gap-4 tw-items-center tw-mt-2 tw-text-xl">
              <BulletArrow className="tw-text-white" />An analytics center that tells the story of your data.
            </li>
          </ul>
        </div>
        <div className="tw-bg-[#FAFF00] tw-w-full tw-max-h-96 tw-flex tw-flex-shrink-0 tw-rounded-[48px] tw-items-start tw-justify-start tw-overflow-hidden lg:tw-max-w-[600px] lg:tw-max-h-[600px]">
          <img 
            ...
            className="tw-max-w-none tw-w-[1440px] tw-ml-24 tw-mt-24 tw-rounded-xl"
            style={{ boxShadow: '-10px -10px 100px rgba(0,0,0,0.3)' }}
            alt="EchoDash Slack Integration"
          />
        </div>
      </div>

      <div className="tw-py-8 tw-gap-10 tw-max-w-7xl tw-m-auto tw-flex tw-flex-col tw-items-center tw-text-center lg:tw-text-left lg:tw-py-32">
        <span className="tw-bright tw-text-xl tw-font-medium">Free to get started. No credit card needed.</span>
        <h2 className="tw-text-6xl tw-leading-none tw-text-center tw-text-[#0A0079] lg:tw-text-9xl">
        ...
        <div className="tw-w-full tw-mb-16 tw-mt-4 tw-m-auto tw-flex tw-items-end tw-border-[3px] tw-border-[#FAFF00] tw-rounded-[48px] tw-overflow-hidden lg:tw-mb-32">
          <div className="tw-px-12 tw-py-16 tw-flex tw-flex-col tw-gap-10 tw-w-full lg:tw-max-w-lg">
            <div className="tw-flex tw-flex-col tw-gap-2">
                <h3 className="tw-text-5xl">Free</h3>
                <span className="tw-text-xl">(During early access)</span>
            </div>
            <h3><span className="tw-text-7xl tw-mr-2">$0</span><span className="tw-text-5xl">/month</span></h3>
